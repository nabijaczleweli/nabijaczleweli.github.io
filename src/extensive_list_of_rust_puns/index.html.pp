...
BOILERPLATE(Extensive list of Rust puns, Results of many months spent infiltrating the Rastesian community)
...
<ul>
  <li>"Kept wondering what was preventing me from sharing a <samp>Cell</samp> with multiple threads, but then I let the idea <samp>Sync</samp> in."
  ...
  <li>"Indiana Jones and the Raiders of the Lost <samp>Arc&lt;T&gt;</samp>"
