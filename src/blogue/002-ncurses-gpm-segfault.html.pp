...
#define BOILERPLATE_ID a9ebda28-1803-11f1-8353-94de80ae55d5
...
BOILERPLATE(002. An overlong analysis of ^Z+fg crashing ncurses programs for gpm users — blogue, 002. An overlong analysis of ^Z+fg crashing ncurses programs for gpm users, en-GB, BLOGN_T_STYLESHEETS WORD_COUNT_SCRIPT)
<style>
