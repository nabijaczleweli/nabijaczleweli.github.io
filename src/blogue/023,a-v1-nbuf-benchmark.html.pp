...
#define BOILERPLATE_ID a9ebdae9-1803-11f1-836b-94de80ae55d5
...
BOILERPLATE(023‚a. V1 UNIX I/O buffer count vs. performance benchmark — blogue, 023‚a. V1 UNIX I/O buffer count vs. performance benchmark, en-GB, BLOGN_T_STYLESHEETS WORD_COUNT_SCRIPT)
<style>
