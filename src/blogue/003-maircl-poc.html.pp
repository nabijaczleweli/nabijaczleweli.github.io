...
#define BOILERPLATE_ID a9ebda34-1803-11f1-8354-94de80ae55d5
...
BOILERPLATE(003. A proof-of-concept IRC/mail bridge — blogue, 003. A proof-of-concept IRC/mail bridge, en-GB, STYLESHEETS WORD_COUNT_SCRIPT)
<style>
...
<div class="bigcode continuation">
  #include "blogue/003.01-conn-init.shell-session.html"
</div>
...
<div class="bigcode continuing">
  #include "blogue/003.02-conn-blurb.plaintext.html"
</div>
<p class="continuing">
...
<div class="bigcode continuing">
  #include "blogue/003.03-sic-to-mbox-parser.awk.html"
</div>
<p class="continuing">
i.e.
</p>
...
<div class="bigcode continuing">
  #include "blogue/003.04-first-mail.plaintext.html"
</div>
<p class="continuing">
...
<ul class="continuation">
  ...
  <li>appending what follows to <code>/etc/postfix/master.cf</code> (I stole this from the internet,
      ...
      <div class="bigcode">
        #include "blogue/003.05-service-decl.bash.html"
      </div>
      </li>
...
<div class="bigcode continuation">
  #include "blogue/003.06-ircmail.awk.html"
</div>
...
<div class="bigcode continuing">
  #include "blogue/003.07-journal-fragment.plaintext.html"
</div>
<p class="continuation">
