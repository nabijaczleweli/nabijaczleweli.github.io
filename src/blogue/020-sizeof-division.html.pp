...
#define BOILERPLATE_ID a9ebdad1-1803-11f1-8368-94de80ae55d5
...
BOILERPLATE(020. Pre-modern-UNIX sizeof division — blogue, 020. Pre-modern-UNIX sizeof division, en-GB, STYLESHEETS WORD_COUNT_SCRIPT)
<style>
...
#include "blogue/020.01-prestruct-c-c01-optim.oldc.html"
<p class="continuation">
...
#include "blogue/020.02-v5-c12-optim.oldc.html"
<p class="continuing">
but also with a full constant folder:
</p>
#include "blogue/020.03-v5-c12-const.oldc.html"
<p class="continuation">
...
#include "blogue/020.04-sys3-pcc-trees.c.html"
<p class="indented continuation">
...
#include "blogue/020.05-sysvr1-cc.mk.html"
<p class="continuation">
