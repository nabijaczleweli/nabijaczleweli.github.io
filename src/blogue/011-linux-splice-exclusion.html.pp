...
BOILERPLATE(011. pipe exclusion with splice() under Linux — blogue, 011. pipe exclusion with splice() under Linux, en-GB, STYLESHEETS WORD_COUNT_SCRIPT)
<style>
...
#include "blogue/011.01-cat.c.html"
</div>
<p class="continuation">
...
#include "blogue/011.02-v.c.html"
</div>
<p class="indented continuing">
or even
</p>
<div class="bigcode continuation">
#include "blogue/011.03-skt2.c.html"
</div>
