...
#define BOILERPLATE_ID a9ebdac1-1803-11f1-8366-94de80ae55d5
...
BOILERPLATE(018. Mean-shift clustering — blogue, 018. Mean-shift clustering, en-GB, STYLESHEETS FORCED_NEWLINE SCRIPTS)
<style>
...
#include "blogue/018.01-analysis.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.02-pre-computation.rs.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.03-output-mapping.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.04-output-mapping-parboiled.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.05-build.rs.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.06-posterise.hlsl.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.07-driver.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.08-posterise.id.patch.hlsl.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.09-posterise.obvious.patch.hlsl.html"
</div>
<!--
...
<div class="codecontinued">
#include "blogue/018.10-baseline-posterise_kernel.hlsl.inc.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.11-baseline-posterise.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.12-baseline-posterise_mul.hlsl.html"
</div>

<p class="continued">These expand to</p>
<div class="codecontinued">
#include "blogue/018.13-baseline-posterise-inlined.hlsl.html"
</div>
<p class="continuing">and</p>
<div class="codecontinued">
#include "blogue/018.14-baseline-posterise_mul-inlined.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.15-baseline-driver.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.16-branchless-posterise.hlsl.html"
</div>
<div class="codecontinued">
#include "blogue/018.17-branchless-posterise_mul.hlsl.html"
</div>
<div class="codecontinued">
#include "blogue/018.18-branchless-posterise_kernel.hlsl.html"
</div>
<p class="continuing">
which expand to, effectively,
</p>
<div class="codecontinued">
#include "blogue/018.19-branchless-posterise-inlined.hlsl.html"
</div>
<div class="codecontinued">
#include "blogue/018.20-branchless-posterise_mul-inlined.hlsl.html"
</div>
<p class="continuing">
yielding
</p>
...
<div class="codecontinued">
#include "blogue/018.21-bbox-shader.h.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.22-bbox-find_bbox.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.23-bbox-driver.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.24-assign_cell-shader.h.hlsl.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.25-assign_cell-assign_cell.hlsl.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.26-assign_cell-build.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.27-assign_cell-driver.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.29-posterise_grid_kernel.hlsl.inc.hlsl.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.30-posterise_grid-shader.h.hlsl.html"
</div>
<p class="indented continuing">
...
<div class="codecontinued">
#include "blogue/018.31-posterise_grid-driver.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.32-cicada_grid-assign_cell.hlsl.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.33-cicada_grid-shader.h.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.34-cicada_grid-driver.rs.html"
</div>
<p class="indented continued">
...
<div class="codecontinued">
#include "blogue/018.35-cicada_grid-cicada_grid.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.36-oneshot-posterise_kernel.hlsl.inc.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.37-oneshot-driver.rs.html"
</div>
<p class="continuation">
...
<div class="codecontinued">
#include "blogue/018.38-oneshot-posterise_grid_oneshot.kernel.hlsl.inc.hlsl.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.39-oneshot-posterise_grid_oneshot.hlsl.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.40-oneshot-posterise_grid_oneshot.mul.hlsl.html"
</div>
<p class="continuing">
The expansion for PALETTE is entirely unchanged:
</p>
<div class="codecontinued">
#include "blogue/018.41-oneshot-posterise_grid_oneshot-inlined.hlsl.html"
</div>
<p class="continuing">
But MULFREQ reads more data more indirectly:
</p>
<div class="codecontinued">
#include "blogue/018.42-oneshot-posterise_grid_oneshot.mul-inlined.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.43-expand_rgb-main.rs.html"
</div>
<p class="indented continuing">
...
<div class="codecontinued">
#include "blogue/018.44-expand_rgb-driver.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.45-expand_rgb-expand_rgb.hlsl.html"
</div>
<p class="continuing">
...
#include "blogue/018.46-expand_rgb-kernels.hlsl.html"
#undef FORCELINK
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.47-expand_rgb-shader.h.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.48-GAAP-main.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.49-GAAP-driver.rs.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.50-known_rgbs-DEVICE_LOCAL-driver.rs.html"
</div>
<p class="indented continuing">
...
<div class="codecontinued">
#include "blogue/018.51-known_rgbs-DEVICE_LOCAL-expand_rgb.hlsl.html"
</div>
<p class="continuing">
and the new
...
<div class="codecontinued">
#include "blogue/018.52-known_rgbs-DEVICE_LOCAL-distribute_oneshot_freqs.hlsl.html"
</div>
...
#include "blogue/018.53-gilbert-hilbert-driver.rs.html"
#undef decodeh
</div>
...
<div class="codecontinued">
#include "blogue/018.54-gilbert-gilbert-build.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.55-gilbert-gilbert-driver.rs.html"
</div>
<div class="singles">
...
<div class="codecontinued">
#include "blogue/018.56-gilbert-both-driver.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.58-ellipsoid-vs-prism-badmodel-bad.hlsl.html"
</div>
<p class="continuing">
(with MATHJAX(g^{-1}) as <samp>gridpos_to_lab</samp>)
</p>
<div class="codecontinued">
#include "blogue/018.57-ellipsoid-vs-prism-badmodel-shader.h.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.59-ellipsoid-vs-prism-badmodel-good.hlsl.html"
</div>
<p class="continuation">
...
-->
<div class="codecontinued">
#include "blogue/018.60-sum_cells-shader.h.hlsl.html"
</div>
<p class="continuing">
as computed by
...
<div class="codecontinued">
#include "blogue/018.61-sum_cells.kernel.hlsl.inc.hlsl.html"
</div>
<p class="continuing">
and
...
<div class="codecontinued">
#include "blogue/018.62-sum_cells.straight.hlsl.html"
</div>
<p class="continuing">
or
...
<div class="codecontinued">
#include "blogue/018.63-sum_cells.oneshot.hlsl.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.64-sum_cells-driver.rs.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.65-sum_cells-kernel.hlsl.html"
</div>
<p class="continuing">
where, expectedly,
...
<div class="codecontinued">
#include "blogue/018.66-sum_cells+ulp-cond.hlsl.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.67-sum_cells+ulp-instrument.hlsl.html"
</div>
<p class="continuing">
yields
</p>
...
<div class="codecontinued">
#include "blogue/018.68-sum_cells+ulp-fix.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.69-gxyz-unnest.first.hlsl.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.70-gxyz-unnest.second.hlsl.html"
</div>
<!--
...
<div class="codecontinued">
#include "blogue/018.73-gxyz-xyz-assign_cell.hlsl.html"
</div>
<p class="continuing">
and
...
<div class="codecontinued">
#include "blogue/018.74-gxyz-xyz-kernel.hlsl.html"
</div>
<p class="continuation">
...
<div class="codecontinued">
#include "blogue/018.75-groups_accumulator-mutex-driver.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.76-groupshared-find_bbox.hlsl.html"
</div>
<p class="continuing">
...
<div class="codecontinued">
#include "blogue/018.77-groupshared-build.rs.html"
</div>
...
<div class="codecontinued">
#include "blogue/018.78-groupshared-driver.rs.html"
</div>
<p class="continuation">
