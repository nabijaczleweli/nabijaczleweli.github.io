...
#define BOILERPLATE_ID a9ebdaa3-1803-11f1-8362-94de80ae55d5
...
BOILERPLATE(014. PID 0 in V1 UNIX (and V4 nsys, and the PDP-7 proto-UNIX) — blogue, 014. PID 0 in V1 UNIX (and V4 nsys, and the PDP-7 proto-UNIX), en-GB, <link href="/content/assets/prism-twilight.min.css" rel="stylesheet"> BLOGN_T_STYLESHEETS WORD_COUNT_SCRIPT_NON_ENGLISH)
<style>
...
(or <a href="//code.google.com/archive/p/unix-jun72/">unix-jun72</a>
 ...
 which reproduces said dump as <a href="//www.tuhs.org/Archive/Distributions/Research/Dennis_v1/"><samp>svntree-20081216.tar.gz</samp></a>)
which transcribes
...
Both are <a href="//www.tuhs.org/Archive/Distributions/Research/Dennis_v1/">redistributed by the TUHS</a>.
...
<p class="continued">
Which corresponds to <code>sys rele (II)</code> (p. 128) in the <cite><a href="//www.tuhs.org/Archive/Distributions/Research/Dennis_v1/UNIX_ProgrammersManual_Nov71.pdf">UNIX Programmer'<!--'-->s Manual</a></cite>:
</p>
...
#include "blogue/014.01-magick.c.html"
</div>
<p class="continuing">
This means, in order:
</p>
...
<div class="codecontinued">
#include "blogue/014.02-init.c.html"
</div>
...
<div class="codecontinued">
#include "blogue/014.03-sysent.c.html"
</div>
<p class="continuation">
...
<div class="codecontinued">
#include "blogue/014.04-idata.c.html"
</div>
<p class="continuing">
...
<a href="//www.tuhs.org/Archive/Distributions/Research/Dennis_v2/">V2</a>? no.
<a href="//www.tuhs.org/Archive/Distributions/Research/Dennis_v3/">V3</a>? sure, but this is actually a <em>WIP</em> of V4
...
<a href="//www.tuhs.org/Archive/Distributions/Research/McIlroy_v0/">at the TUHS as the number-named PDFs</a>.
The accompanying document —
<cite>D. M. Ritchie'<!--'-->s <samp><a href="//www.tuhs.org/Archive/Distributions/Research/McIlroy_v0/UnixEditionZero-Threshold_OCR.pdf">DRAFT of The UNIX Time-Sharing System</a></samp></cite>
...
<a href="//www.tuhs.org/Archive/Distributions/Research/PDP7/pdp7-unix-master.zip">zipped git export with no history</a>,
...
<div class="codecontinued">
#include "blogue/014.05-coldstart.c.html"
</div>
