...
#define BOILERPLATE_ID a9ebda5b-1803-11f1-8359-94de80ae55d5
...
BOILERPLATE(007. Cleanly enabling Cyrillic and broad Unicode output in groff -Tps — blogue, 007. Cleanly enabling Cyrillic and broad Unicode output in groff -Tps, en-GB, STYLESHEETS WORD_COUNT_SCRIPT)
<style>
...
#include "blogue/007.02-original.shell-session.html"
</div>
<p class="continuing">
...
<div class="bigcode continuing">
#include "blogue/007.03-Kutf8.shell-session.html"
</div>
<p class="continuing">
...
<div class="bigcode continuing">
#include "blogue/007.04-linuxtravels.shell-session.html"
</div>
<p class="continuing">
...
<ol class="wide-explanation continuation">
	...
	<li>The Ghostscript font map (<code>/var/lib/ghostscript/fonts/Fontmap</code> from <code>/etc/ghostscript/fontmap.d/<!---->*</code> by <code>update-gsfontmap</code>)
	    ...
	    with the interesting mappings being in the format:
			<div class="bigcode continuing">
#include "blogue/007.05-Fontmap.plaintext.html"
	    </div>
	...
	<li>For each font in <code>/usr/share/fonts/type1/gsfonts/</code>, there are three files:
	    <div class="bigcode continuing">
#include "blogue/007.06-u-s-f-t1-gsfonts.shell-session.html"
	    </div>
...
<div class="bigcode continuing">
#include "blogue/007.10-liberation2.shell-session.html"
</div>
<p class="continuing">
...
#include "blogue/007.11-diag.shell-session.html"
</div>
...
<div class="bigcode continuation">
#include "blogue/007.12-frag.1.plaintext.html"
</div>
