...
#define BOILERPLATE_ID a9ebda43-1803-11f1-8356-94de80ae55d5
...
BOILERPLATE(005. Low-curse ZFS-on-root for new Debian installations on multi-disk systems — blogue, 005. Low-curse ZFS-on-root for new Debian installations on multi-disk systems, en-GB, STYLESHEETS WORD_COUNT_SCRIPT)
<style>
...
<div class="bigcode continuing">
  #include "blogue/005.01-grub-features.c.html"
</div>
<p class="continuing">
Which means that these, as of OpenZFS 0.8.4, are the ones that it doesn'<!--'-->t support:
</p>
<div class="bigcode continuing">
  #include "blogue/005.02-grub-nonfeatures.shell-session.html"
</div>
...
<div class="bigcode">
#include "blogue/005.03-mount-tree.plaintext.html"
</div>
...
<div class="bigcode continuing">
#include "blogue/005.04-mounts.shell-session.html"
</div>
<p class="indented continuation">
...
<div class="bigcode">
#include "blogue/005.05-final-list.shell-session.html"
</div>
