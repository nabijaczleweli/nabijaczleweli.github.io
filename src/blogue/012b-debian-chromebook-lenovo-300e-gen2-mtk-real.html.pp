...
#define BOILERPLATE_ID a9ebda91-1803-11f1-8360-94de80ae55d5
...
BOILERPLATE(012b. Debian on the Lenovo 300e 2nd-gen MTK arm64 Chromebook (hana) (real) — blogue, 012b. Debian on the Lenovo 300e 2nd-gen MTK arm64 Chromebook (hana) with MediaTek MT8173/MT8173C (real), en-GB, STYLESHEETS WORD_COUNT_SCRIPT_NON_ENGLISH)
<style>
...
<div class="bigcode">
#include "blogue/012b.01-usb-boot.shell-session.html"
</div>
<p class="continuing">
and it do b honkin
</p>
...
#include "blogue/012b.02-p12-uimg.dts.html"
</div>
<p class="continuing">
...
#include "blogue/012b.03-fiddle-shell.diff.html"
</div>
...
<div class="continuing-inside">
#include "blogue/012b.04-fiddle-final.diff.html"
</div>
<p class="continuing">
...
#include "blogue/012b.05-xorg.plaintext.html"
</div>
<p class="continuing">
...
<details>
	...
	<div class="continuing-inside bigcode">
	#include "blogue/012b.06-sbin-init.sh.html"
	</div>
</details>
<p class="continuing">
...
#include "blogue/012b.08-repack.shell-session.html"
</div>
<p class="continuation">
...
<div class="continuing-inside">
#include "blogue/012b.09-faux-root.Makefile.html"
</div>
<p class="continuing">a simple init script to log the file every second</p>
<div class="continuing-inside">
#include "blogue/012b.10-faux-root.init.sh.html"
</div>
<p class="continuing">
and
...
#include "blogue/012b.11-repack-full.shell-session.html"
</div>
<p class="continuing">
...
<div class="continuing-inside">
#include "blogue/012b.12-d_t_c-analysis.shell-session.html"
</div>
<p class="continuing">
to then upgrade
...
<div class="continuing-inside">
#include "blogue/012b.13-alsaucm.shell-session.html"
</div>
<p class="continuing">
...
<div class="continuing-inside">
#include "blogue/012b.14-alsa-state.javascript.html"
</div>
<p class="continuing">
...
#include "blogue/012b.15-amixer-scontents.javascript.html"
</div>
<p class="continuing">
...
#include "blogue/012b.16-amixer-contents.javascript.html"
</div>
<p class="continuing">
...
<div class="bigcode continuing-inside">
#include "blogue/012b.17-auto-output.sh.html"
</div>
<p class="continuing">
...
#include "blogue/012b.18-keyd.ini.html"
</div>
<p class="continuing">
suffices.
</p>
...
#include "blogue/012b.19-mux.dts.html"
</div>
<p class="continuing">
...
<div class="bigcode continuing-inside" style="position: relative;">
<a href="//lfs.nabijaczleweli.xyz/0018-debian-chromebook-lenovo-300e-gen2-mtk-real/mmcblk0p2.mt8173-elm-hana.dts"><aside>full device tree</aside></a>
#include "blogue/012b.20-analogix.dts.html"
</div>
<p class="continuation">
...
<div class="bigcode continuing-inside">
#include "blogue/012b.21-mkimage.dts.html"
</div>
<p class="continuation">
...
<div class="bigcode continuing-inside">
#include "blogue/012b.22-fullkern.shell-session.html"
</div>
<p class="continuing">
