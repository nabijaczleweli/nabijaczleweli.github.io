...
#define BOILERPLATE_ID a9ebdae0-1803-11f1-836a-94de80ae55d5
...
BOILERPLATE(022. Turning the V4 UNIX dump into Utah_v4/ — blogue, 022. Turning the V4 UNIX dump into Utah_v4/, en-GB, BLOGN_T_STYLESHEETS FONTAWESOME_LINK WORD_COUNT_SCRIPT)
<style>
...
<span style="letter-spacing: 0.2rem;">UNIX</span><!--"-->  <!--"-->Original
from Bell Labs<!--"-->     <!--"-->V4
(See Manual for format)\
		</blockquote>
	</li>
	<li><a href="//archive.org/download/utah_unix_v4_raw/v4.sal"><tt>v4.sal</tt></a> (1.2G) — ZIP of 9 analog captures with a SALEAE logic analyser</li>
	<li><a href="//archive.org/download/utah_unix_v4_raw/analog.tbin"><tt>analog.tbin</tt></a> (1.6G) — compressed readtape <tt>TBINHDR</tt> blob</li>
	<li><a href="//archive.org/download/utah_unix_v4_raw/analog.tap"><tt>analog.tap</tt></a> (2.5M) — the binary tape image REDACTED</li>
</ul>
...
Conceptually, the REDACTED part above was "in a hard-to-use custom format that we didn't say what it was".
...
means that this file <em>supposes to be</em> the right version, but just… isn't.<!--'-->
...
Every unix I've<!--'--> looked at except Solaris (glibc/musl, {Net,Open,Free}BSD) has a <tt>long</tt> and <tt>const char *</tt> as well.
...
<pre>\
$ <a href="//git.sr.ht/~nabijaczleweli/Utah_v4/tree/cde08dafa2d7ed4b4cad4a072d8ee0e70638a497/item/simh2raw.cpp#L11">make simh2raw</a> && &lt; analog.tap ./simh2raw > ARTIFACT(v4tape)
...
<p class="indented continued">
Maybe this is a mt (I)/tap (I, V), à la V3?
...
<p class="continuing">
all <tt><var>?</var>boot</tt>s I've<!--'--> seen have a <tt>W<del>…</del>N</tt> sequence,
...
<p class="indented continued">
Much of the time, when analysing unix software, but especially from this era, you have to ask yourself:
what's<!--'--> the simplest, stupidest, least-structured way of doing <var>whatever</var>?
Given these givens:
</p>
<ol>
	<li>we have an installation tape</li>
	<li>to be installed, a unix rootfs needs to be on a disk</li>
...
<!--"-->0000b0 d4 a4 07 02 02 21 fc 87 80 1c f0 ff c1 65 0e 00  <!--"-->>Ԥ*...!.......e..&lt;
...
<!--"-->000190 21 10 e1 15 20 ba e1 15 00 ff e1 15 05 00 c9 8b  <!--"-->>!... .........ɋ*&lt;
<!--"-->0001a0 fe 04 81 15 87 00 c0 15 70 ff 88 0a c8 8b fe 04  <!--"-->>........p...ȋ*..&lt;
...
<!--"-->0000a0 d4 a4 07 02 02 21 fc 87 80 1c f0 ff c1 65 0e 00  <!--"-->>Ԥ*...!.......e..&lt;
...
<!--"-->000180 21 10 e1 15 20 ba e1 15 00 ff e1 15 05 00 c9 8b  <!--"-->>!... .........ɋ*&lt;
<!--"-->000190 fe 04 81 15 87 00 c0 15 70 ff 88 0a c8 8b fe 04  <!--"-->>........p...ȋ*..&lt;
...
<ul>
	...
	<li>you can download <em>my</em> artifacts, which I've<!--'--> produced on bookworm with libarchive 3.7.2-2.1:
		<ul>
			<li>ARTIFACT(v4tape) — the raw binary tape file, what <tt>analog.tap</tt> wanted to be</li>
