...
#define BOILERPLATE_ID a9ebda9a-1803-11f1-8361-94de80ae55d5
...
BOILERPLATE(013. Linux a.out quine in 44 bytes — blogue, 013. Linux a.out quine in 44 bytes, en-GB, BLOGN_T_STYLESHEETS WORD_COUNT_SCRIPT_NON_ENGLISH)
<style>
