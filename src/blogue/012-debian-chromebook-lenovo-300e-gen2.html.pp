...
#define BOILERPLATE_ID a9ebda82-1803-11f1-835e-94de80ae55d5
#include "../writing/writing.h"
#include "../common.h"
#include "blogue.h"


   <!-- RSS_PUB_DATE: "Mon, 08 Jan 2024 16:06:34 +0100" -->
#define POST_DATE      Mon, 08 Jan 2024 16:06:34 +0100
#define POST_POST_DATE


BOILERPLATE(012. Debian on the Lenovo 300e 2nd-gen arm64 Chromebook — blogue, 012. Debian on the Lenovo 300e 2nd-gen arm64 Chromebook with MediaTek MT8173/MT8173C, en-GB, BLOGN_T_STYLESHEETS WORD_COUNT_SCRIPT_NON_ENGLISH)
<style>
...
HEADING_S(2, jpeg, class="continued", peep da nose cam)
...
HEADING_S(2, jailbreak, class="continued", Save me from chromium (chrome os (chromium os(?))))
<p class="continuing">
...
HEADING(2, HFBITLAND, Take me to <span class="smallcaps">hfbitland</span>)
...
HEADING_S(2, kms, class="continued", fuckin kms i s'<!--'-->pose)
