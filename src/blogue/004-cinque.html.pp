...
#define BOILERPLATE_ID a9ebda3d-1803-11f1-8355-94de80ae55d5
#include "../writing/writing.h"
#include "../common.h"
#include "blogue.h"


   <!-- RSS_PUB_DATE: "Sat, 18 Jul 2020 22:14:33 +0200" -->
#define POST_DATE      Sat, 18 Jul 2020 22:14:33 +0200
#define POST_POST_DATE

BOILERPLATE(004. New album: cinque — blogue, 004. New album: cinque, en-GB, BLOGN_T_STYLESHEETS WORD_COUNT_SCRIPT)
<style>
#include "../indent.css"
