...
#define BOILERPLATE_ID a9ebd30e-1803-11f1-8352-94de80ae55d5
...
BOILERPLATE(001. Installing Debianꞌs x32 port in 2020 — blogue, 001. Installing Debianꞌs x32 port in 2020, en-GB, STYLESHEETS WORD_COUNT_SCRIPT)
<style>
...
<div class="bigcode">
#include "blogue/001.01-disklabel.shell-session.html"
</div>
</p>
