...
<pre class="bigcode continuation"><samp><!--
-->$ <kbd>curl https://nabijaczleweli.xyz/content/assets/blogn_t/010.1-tme-0.8-ptmx | patch</kbd>
$ <kbd>make -j25</kbd><!--
--></samp></pre>
...
this is likely related to the emulator being in a tight <code>pselect6()</code> loop with a zero <var>timeout</var>.
I'<!--'-->d attribute this to a GDK incompatibility probably, idk what else it could be doing.
</p>
<p class="indented continuing">
