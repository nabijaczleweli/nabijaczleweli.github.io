...
#include "blogn_t/021.01-observation.shell-session.html"
<p class="continuing">
Yowza! but how?
...
#include "blogn_t/021.02-epistemic-fdisk.shell-session.html"
<p class="continuing">
No ESP tag… does this system boot via EFI at all?
<del>And how the hell is GPT support <cite>new</cite>?</del>
</p>
#include "blogn_t/021.03-epistemic-efibootmgr,file-s.shell-session.html"
<p class="continuing">
...
#include "blogn_t/021.04-prep-disk-layout.shell-session.html"
<p class="continuing">
...
#include "blogn_t/021.05-dmsetup-mirror.shell-session.html"
<p class="continuing">
Of note here:
</p>
<ul>
...
#include "blogn_t/021.06-mdadm-raid1-v0.shell-session.html"
<p class="continuing">
The date ends up at the front of the partitions, the device is 64k shorter…
</p>
#include "blogn_t/021.07-mdadm-raid1-v0-superblock.shell-session.html"
<p class="continuing">
...
#include "blogn_t/021.08-mdadm-raid1-v1.0.shell-session.html"
<p class="continuation">
...
#include "blogn_t/021.12-conclusion.sh.html"
