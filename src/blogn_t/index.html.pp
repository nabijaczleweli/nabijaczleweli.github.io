...
#define POST(post_id, post_time, post_time_2, ...)  \
	<p>PPOST(post_id, post_time, post_time_2, __VA_ARGS__)</p>
...
#define STYLESHEETS MAIN_HEADING_STYLE                                                                 FORCED_NEWLINE \
                    ...
                    <style>samp { font-family: "Droid Sans Mono", monospace; display: block; }</style>
...
<p>
	PPOST(005-low-curse-zfs-on-root,               Mon, 14 Sep 2020 00:20:20 +0200, 005. Low-curse ZFS-on-root for new Debian installations on multi-disk systems)
...
<p>
	PPOST(012-debian-chromebook-lenovo-300e-gen2,  Mon, 08 Jan 2024 16:06:34 +0100, 012. Debian on the Lenovo 300e 2<sup>nd</sup>-gen arm64 Chromebook)
